      ...
      if (matchingTemplateIndex !== -1) {
        ...
        try {
          ...
          if (matchingTemplateIndex === primaryTemplateIndex) {
            ...
            const errorHandler = hostLView[INJECTOR]?.get(ErrorHandler, null);
            console.log('DEBUG @boundary: Caught error', e);
            console.log('DEBUG @boundary: INJECTOR is', hostLView[INJECTOR]);
            console.log('DEBUG @boundary: ErrorHandler resolved to', errorHandler);
            if (errorHandler) {
