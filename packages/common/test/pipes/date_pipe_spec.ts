...
import {DATE_PIPE_DEFAULT_OPTIONS, DatePipe, useLegacyDateFormatting} from '@angular/common';
import localeEn from '@angular/common/locales/en';
import localeEnExtra from '@angular/common/locales/extra/en';
import {useDefaultDateFormatting} from '@angular/common/src/i18n/format_date';
...
describe('DatePipe', () => {
  ...
  describe('transform', () => {
    ...
    it('should take timezone into account with timezone offset when using legacy formatting', () => {
      ...
      useDefaultDateFormatting(); // Reset to default for the others tests
    });

    it('should throw when using timezone into with timezone offset', () => {
      // This is not supported with the Intl implementation
    ...
    it('should take the default timezone into account when no timezone is passed in', () => {
      pipe = new DatePipe('en-US', 'Etc/GMT+12');
    ...
    it('should use timezone provided in component as default timezone when no format is passed in', () => {
      @Component({
        ...
        template: '{{ value | date }}',
        standalone: true,
        providers: [{provide: DATE_PIPE_DEFAULT_OPTIONS, useValue: {timezone: 'Etc/GMT+12'}}],
      })
      class TestComponent {
